...
export function SideBar() {
  return (
<div className="fixed inset-y-0 left-0 z-1 w-64 overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0 h-full">
